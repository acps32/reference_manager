...
def main():
    # Au cas où le script tourne sans que le serveur n'ait jamais démarré(donc sans que les tables n'existent encore) 
    # : create_all() ne fait rien si elles sont déjà là.
